...
export const TALENTS = {
  warrior: [
    ...
    { id: 'w_powerburn', tier: 2, name: 'Сокрушение', desc: 'Мощный удар: +40% урона', flag: 'ab_power' },
    { id: 'w_cryheal', tier: 3, name: 'Вдохновляющий клич', desc: 'Боевой клич лечит союзников на ½ сердца', flag: 'ab_cryheal' },
    { id: 'w_whirlfar', tier: 3, name: 'Стальной шторм', desc: 'Вихрь стали летит на 50% дальше', flag: 'ab_whirlfar' },
  ...
  mage: [
    ...
    { id: 'm_wavewide', tier: 2, name: 'Пламенный вал', desc: 'Огненная волна шире и дальше', flag: 'ab_wave' },
    { id: 'm_novadeep', tier: 3, name: 'Вечная мерзлота', desc: 'Ледяная нова замораживает почти намертво', flag: 'ab_nova' },
    { id: 'm_blinkburn', tier: 3, name: 'Пылающий след', desc: 'Телепорт оставляет взрыв в точке старта', flag: 'ab_blink' },
  ...
  rogue: [
    ...
    { id: 'r_dashstun', tier: 2, name: 'Ошеломление', desc: 'Рывок теней оглушает на 1 с', flag: 'ab_dash' },
    { id: 'r_smokespd', tier: 3, name: 'Дым и зеркала', desc: 'Завеса дольше (5 с) и даёт +30% скорости', flag: 'ab_smoke' },
    { id: 'r_bladefan', tier: 3, name: 'Стальной ливень', desc: 'Град клинков: +6 клинков', flag: 'ab_blades' },
  ],
};
