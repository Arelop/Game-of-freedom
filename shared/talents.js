...
export const TALENTS = {
  warrior: [
    ...
    { id: 'w_butcher', spec: 'berserk', tier: 3, ranks: 1, name: 'Мясник', desc: 'ДОБИВАНИЕ возвращает 1 сердце', flag: 'butcher' },
    ...
    { id: 'w_break', spec: 'guard', tier: 2, ranks: 1, name: 'Крушитель', desc: 'Тяжёлые атаки ломают СТОЙКОСТЬ на 60% сильнее', flag: 'heavybreak' },
  ...
  mage: [
    ...
    { id: 'm_brittle', spec: 'cryo', tier: 3, ranks: 1, name: 'Хрупкость льда', desc: 'Удары по врагам с меткой ЛЬДА ломают СТОЙКОСТЬ вдвое', flag: 'brittleice' },
    ...
    { id: 'm_pierce', spec: 'arcane', tier: 2, ranks: 1, name: 'Таранный сгусток', desc: 'Заряженный выстрел ломает СТОЙКОСТЬ вдвое (×2.5)', flag: 'chargebreak' },
  ...
  rogue: [
    ...
    { id: 'r_pounce', spec: 'assassin', tier: 2, ranks: 1, name: 'Хищник', desc: 'Роллинг-выпад: ×1.5 урона и окно после переката шире', flag: 'pounce' },
    ...
    { id: 'r_dance', spec: 'trickster', tier: 3, ranks: 1, name: 'Кровавый танец', desc: 'ДОБИВАНИЕ возвращает перекат', flag: 'dancefinish' },
  ...
  priest: [
    ...
    { id: 'p_inspire', spec: 'light', tier: 2, ranks: 1, name: 'Вдохновение', desc: 'Любое ДОБИВАНИЕ рядом лечит отряд на 1', flag: 'inspire' },
    ...
    { id: 'p_holybreak', spec: 'wrath', tier: 2, ranks: 1, name: 'Сокрушающий свет', desc: 'Твои станы ломают СТОЙКОСТЬ боссов и элиты вдвое сильнее', flag: 'holybreak' },
  ...
  necromancer: [
    ...
    { id: 'n_marrow', spec: 'bone', tier: 2, ranks: 1, name: 'Костолом', desc: 'Костяное копьё ломает СТОЙКОСТЬ вдвое', flag: 'marrow' },
    ...
    { id: 'n_rot', spec: 'blight', tier: 3, ranks: 1, name: 'Гнилые жилы', desc: 'Враги под твоим дотом теряют СТОЙКОСТЬ на 40% быстрее', flag: 'rotpoise' },
